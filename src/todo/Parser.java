...
public class Parser {
	...
	/**
	 * This function performs the actual parsing of a view type command and creates a view  
	 * command type object 
	...
	private ViewCommand parseView() throws ParseException{
		...
		else if(isViewCommandDisplayingTasksOnADate(dateStr)){//incorrect find correct way 
	...
	/**
	 * This function performs the actual parsing of a delete type command and creates a delete  
	 * command type object 
	...
	/**
	 * This function performs the actual parsing of a change type command and creates a modify  
	 * command type object 
	...
	/**
	 * This function performs the actual parsing of a reschedule type command and creates a 
	 * modify command type object 
	...
	/**
	 * This function performs the actual parsing of a add type command and creates a 
	 * add command type object 
	...
	/**
	 * This function returns the command type part of the user input and also truncates
	 * the user input
	 * 
	 * Return Type: string
	 * 
