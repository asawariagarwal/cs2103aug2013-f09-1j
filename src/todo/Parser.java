...
/* Not sure if main is necessary or the function will be called directly from the other class
...
*/
	...
	/**
	 * This function is used to check if the string inputed by the user is valid or not
	 * If the input is valid it returns true and creates a command object 
	 * Else it returns false
	 * 
	 * Return Type: boolean 
	 */
	
	public boolean parseInput(){ //return true is the user Input is valid else return false
					...
					ViewCommand command = new ViewCommand(false, true);
						...
						ViewCommand command = new ViewCommand(true);
							...
							if(isDateValid(Date_str)&&(_userInput.equals("by tags"))){
								...
								//The Following lines are used to create a calendar type object using a date string
...
/* The following commands haven't been implemented yet so the code has been commeted out 
 * for the walking skeleton
				...
				if(_userInput.equals("all expired")){
					//create DeleteAllExpiredObject and call command using it
						...
						//create DeleteAllDoneObject and call command using it
							...
							//create DeleteTaskObject and call command using it
						}
				return true;
			}
		}
		...
		case "drop":{
			if(_userInput.equals("")){
				...
				//Create DropObject and call command using it 
			}
			return true;
		}
		...
		case "undo":{
			if(_userInput.equals("")){
				//create Undotype object and call command using it
			}
			else{
...
*/
	...
	/**
	 * This function returns the first word of the user input and also truncates the user input
	 * 
	 * Return Type: string
	 * 
	 */
	...
	/**
	 * This function extracts and returns the string from the beginning to the keyword specified
	 * from the user input and also truncates the user input
	 * 
	 * Return Type: string
	 * 
	 */
...
/**
 * This function uses a regex to check if the format of the date enetered is correct 
 * 
 * Return Type is Boolean
 */
	private boolean isDateValid(String Date_str)//Checks if the date format is correct or not use regex here to check 
	{
	...
	/**
	 * This function is used in case the Task is a deadline task and it parses the input to create a deadline type object 
	 */
...
/**
 * This function is used in case the task is a floating task and it parses the input to create a floating type object 
 */
	...
	/** 
	 * This function is used in case the Task is a timed task and it parses the input to create a timed task type object
	 */
	private boolean parseTimedTask(string _userInput)
	{
		...
		//The Following lines are used to create a calendar type objects using a date string
				SimpleDateFormat curFormater = new SimpleDateFormat("dd/MM/yyyy"); 
...
/**
 * This function extract the string in user input upto the end or upto the hashtags 
 * 
 * Return Type : String 
 */
