...
public void SetUp(){
	...
	public void addDeadlineTest() throws ParseException {
		...
		Calendar deadlineActual = displayState.getDeadlineTasks().last().getDeadline();
		assertEquals(deadlineExpected.get(Calendar.DAY_OF_YEAR), deadlineActual.get(Calendar.DAY_OF_YEAR));
	...
	public void addTimedTest() throws ParseException{
		...
		//Checks if the calendar object stored in the state is correct
		Calendar startActual = displayState3.getTimedTasks().last().getStartDate();
		assertEquals(startExpected.get(Calendar.DAY_OF_YEAR), startActual.get(Calendar.DAY_OF_YEAR));
		
		Calendar endActual = displayState3.getTimedTasks().last().getEndDate();
		assertEquals(endExpected.get(Calendar.DAY_OF_YEAR), endActual.get(Calendar.DAY_OF_YEAR));
